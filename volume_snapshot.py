...
# --rotate = if daily or weekly snapshot is in effect, delete old daily or weekly snapshots
...
try:
    ...
    if args.verbose:
        print 'Failed to connect to EC2 Console!'
    sys.exit(e)
...
for volume in volumes:
    ...
    if args.daily or args.weekly:
        ...
        stamp = time.strftime("%Y-%b-%d %H:%M:%S %Z", time.localtime()) + '; ' + instance.tags[
            'Name'] + '; ' + instance.id + '; ' + volume.id
